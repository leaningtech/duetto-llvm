...
bool CheerpWasmWritePass::runOnModule(Module& M)
{
  ...
  cheerp::LinearMemoryHelper linearHelper(M, cheerp::LinearMemoryHelper::FunctionAddressMode::Wasm, GDA, CheerpHeapSize, CheerpStackSize);
  ...
  if (WasmLoader.empty())
  {
    ...
    cheerp::CheerpWasmWriter writer(M, *this, Out, PA, registerize, GDA, linearHelper, namegen,
                                    ...
                                    PrettyCode, CfgLegacy, cheerpMode);
    writer.makeWasm();
  }
  else
  {
